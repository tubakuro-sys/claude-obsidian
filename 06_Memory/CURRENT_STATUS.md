...
- [ ] 簿記アプリ：復習リスト機能追加
- [ ] 習慣トラッカー設計・v1実装開始
- [x] syarou v9 GitHub Pagesリリース（運用中のため完了）

---

## ⚡ 直近の決定事項（2026-06-01）

- ITパスポート学習前倒し決定：6/7〜14頃受験を目標に集中学習開始
- 簿記・TOEICはITパス合格後に集中着手の方针に変更
- ITパス弱点：公開鍵暗号・ITIL・リスク対応・テスト手法・EVM・2進数計算・RAID・OAuth・ゼロトラスト・量子コンピュータ
